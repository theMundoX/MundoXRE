...
Run-Step "public-agent-emails" 'npx tsx scripts/enrich-agent-emails-public.ts --state=IN --city=INDIANAPOLIS --limit=500 --concurrency=2 --delay-ms=500 --max-search-queries=4 --max-search-links=8 --max-direct-profile-urls=12 --max-profile-links-per-page=8 --fetch-timeout-ms=7000 --row-timeout-ms=45000 --retry-after-hours=24 --allow-name-email-profile --allow-no-phone'
