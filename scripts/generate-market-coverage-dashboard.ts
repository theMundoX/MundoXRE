...
const MARKETS: MarketConfig[] = [
  ...
  },
  {
    ...
    rerunCommands: [
      ...
      "npx tsx scripts/enrich-redfin-detail-pages.ts --state=AL --city=BIRMINGHAM --limit=1800 --delay-ms=300",
      "npx tsx scripts/score-creative-finance-signals.ts --state=AL --city=BIRMINGHAM --limit=2000",
    ],
  },
  {
    key: "detroit-mi",
    ...
    state: "MI",
    countyId: 1973412,
    countyName: "Detroit (Wayne)",
    targetCountyHints: ["Wayne County"],
    listingCity: "DETROIT",
    listingScopeNote: "Active build market using Detroit ZIP Redfin-derived active rows; Detroit public parcel ingest is loaded; recorder/debt work remains a build gap.",
    parcelScopeNote: "Detroit public parcel coverage is loaded under the Detroit (Wayne) county scope.",
