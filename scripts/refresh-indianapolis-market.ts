...
const steps: Step[] = [
  ...
  },
  {
    ...
    command: [
      "npx",
      "tsx",
      "scripts/enrich-agent-emails-public.ts",
      "--state=IN",
      "--city=INDIANAPOLIS",
      "--limit=50",
      "--concurrency=2",
      ...
      "--max-search-links=8",
      "--max-direct-profile-urls=12",
      "--max-profile-links-per-page=8",
      "--fetch-timeout-ms=7000",
      "--row-timeout-ms=45000",
  ...
  },
  {
    ...
    command: [
      ...
      "--cursor-file=.cache/marion-fidlar-on-market-pull.cursor",
      ...(DRY_RUN ? ["--dry-run"] : []),
    ],
    required: false,
    supportsDryRun: true,
  ...
  {
    name: "Backfill Marion recorder rows by corporate owner names",
    command: [
      "npx",
      "tsx",
      "scripts/fidlar-investor-lien-search.ts",
      "--name-source=corporate",
      "--from-year=2020",
      "--limit=5000",
      "--max-run-ms=1800000",
      "--per-entity-timeout-ms=45000",
      "--cursor-file=.cache/marion-fidlar-corporate-pull.cursor",
      ...(DRY_RUN ? ["--dry-run"] : []),
    ],
    required: false,
    supportsDryRun: true,
  ...
  },
  {
    ...
    command: [
      ...
      "--cursor-file=.cache/marion-fidlar-owner-linker-amounts.cursor",
      ...(DRY_RUN ? ["--dry-run"] : []),
    ],
    required: false,
    supportsDryRun: true,
  ...
  },
  {
    ...
    command: [
      ...
      "--limit=10000",
      "--max-run-ms=900000",
      "--cursor-file=.cache/marion-fidlar-owner-linker.cursor",
      ...(DRY_RUN ? ["--dry-run"] : []),
    ],
    required: false,
    supportsDryRun: true,
