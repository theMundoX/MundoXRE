...
const MARKET_CONFIGS: Record<string, {
  ...
  chardon: {
    ...
    restrictions: [
      'Production searchable inventory is enabled for BBC with field-level quality flags; enrichment remains incomplete and should not be presented as full-market underwriting coverage.',
      'Coverage is currently single-source Redfin inventory linked into Geauga County property rows for Chardon, including 7 listing-backed shells retained only for active listings that did not resolve to parcel identity.',
      'Active inventory is fully linked with no remaining unlinked rows; 50 of 57 active properties currently carry parcel identity and ownership support while 7 remain address-level fallback coverage pending assessor reconciliation.',
    ...
    fallbackCoverageMetrics: {
      ...
      listings: {
        ...
        brokerage_count: 0,
        creative_finance_count: 0,
        latest_listing_seen: '2026-06-22 07:58:53.961836+00',
        listing_sources: ['redfin'],
      },
      debt: {
